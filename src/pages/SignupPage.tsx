        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg w-[520px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-sm text-gray-700 mb-1">역할</label>
                <select 
                  className="w-full px-3 py-2 rounded bg-gray-100 text-gray-900 outline-none border border-gray-300 focus:border-blue-500" 
                  value={role} 
              ...
              <div>
                <label className="block text-sm text-gray-700 mb-1">학번/교번</label>
                <input 
                  className="w-full px-3 py-2 rounded bg-gray-100 text-gray-900 outline-none border border-gray-300 focus:border-blue-500" 
                  value={studentId} 
              ...
              <div>
                <label className="block text-sm text-gray-700 mb-1">학교</label>
                <input 
                  className="w-full px-3 py-2 rounded bg-gray-100 text-gray-900 outline-none border border-gray-300 focus:border-blue-500" 
                  value={school} 
              ...
              <div>
                <label className="block text-sm text-gray-700 mb-1">학과/부서</label>
                <input 
                  className="w-full px-3 py-2 rounded bg-gray-100 text-gray-900 outline-none border border-gray-300 focus:border-blue-500" 
                  value={department} 
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            이미 계정이 있으신가요? {""}
            <button className="text-blue-600 hover:underline" onClick={() => navigate("/login")}>로그인</button>
          </p>
        </div>
      </div>
    </div>
