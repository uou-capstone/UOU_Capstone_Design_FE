...
/** 화살표 위·트레이(자료 업로드) */
export const UploadTrayIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M16 12l-4-4m0 0l-4 4m4-4v9"
    />
  </svg>
);
